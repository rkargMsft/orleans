...
namespace Orleans.Runtime.Placement.Filtering
{
    ...
    public partial class PreferLocalPlacementFilterAttribute : Orleans.Placement.PlacementFilterAttribute
    {
        public PreferLocalPlacementFilterAttribute(int order = 0) : base(default!) { }
    }

    public partial class PreferLocalPlacementFilterStrategy : Orleans.Placement.PlacementFilterStrategy
    {
        public PreferLocalPlacementFilterStrategy() : base(default) { }

        public PreferLocalPlacementFilterStrategy(int order) : base(default) { }
    }
